...
object Score extends java.io.Serializable{
  ...
  def run(sc: SparkContext, crimes_raw: RDD[(Int, List[(Int, Int)])], metros: RDD[(Int, Double)], aqis_raw: RDD[(Int, List[(Int, Double)])], values: RDD[(Int, Double)], outputPrefix: String, agg_d_output: String, agg_s_output: String): List[String] = {
  ...
  def scoreError(sc: SparkContext, input: String, outputPrefix: String): String = {
